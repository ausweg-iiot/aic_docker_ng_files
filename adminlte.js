...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/ function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem = "<li class=\"nav-item\" role=\"presentation\"><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"btn-iframe-refresh\"><i class=\"fas fa-sync\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
    ...
    _proto.openTabSidebar = function openTabSidebar(item, autoOpen) {
      ...
      if ($item.length != 0) {
        if ($item.hasClass('dropdown-item')) {
          ...
          icon = $item.find('.nav-icon')[0].outerHTML;
        }
      }
      var title = icon + $item.text();
